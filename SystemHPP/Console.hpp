...
namespace Sys
{
	...
	public:
		...
		static void Write(char16_t arg);
		static void Write(const char16_t* arg);
		static void Write(const std::u16string& arg);
		static void Write(char32_t arg);
		static void Write(const char32_t* arg);
		static void Write(const std::u32string& arg);
